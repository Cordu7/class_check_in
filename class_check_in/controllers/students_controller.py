...
def low():
    students = student_repository.select_all()
    return render_template("students/low.html", students = students)

@students_blueprint.route("/students/ready")
def ready():
    students = student_repository.select_all()
    return render_template("students/ready.html", students = students)

@students_blueprint.route("/students/unsettled")
def unsettled():
    students = student_repository.select_all()
    return render_template("students/unsettled.html", students = students)

@students_blueprint.route("/students/out-of-control")
def out_of_control():
    students = student_repository.select_all()
    return render_template("students/out-of-control.html", students = students)
